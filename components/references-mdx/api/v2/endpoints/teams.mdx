...
| **joinedFrom.projectId** | <HelpLink href="#api-basics/types">String</HelpLink>       | No       | This field is required for GitHub, GitLab, and Bitbucket. The ID of the project that will be deployed.                                                                                                                                                                                         |
